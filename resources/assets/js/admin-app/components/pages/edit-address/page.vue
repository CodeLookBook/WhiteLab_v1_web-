        ...
        :lg="{span:12, offset: 1}"
            ...
            el-row
                ...
                :lg="24"
                    ...
                    h3(v-if="ADMIN_APP_LANGUAGES.RUSSIAN === language") РЕДАКТИРОВАНИЕ ИЗОБРАЖЕНИЯ КАРТЫ С АДРЕСОМ САЛОНА
                    h3(v-if="ADMIN_APP_LANGUAGES.SLOVAK  === language") IMAGE ADRESA REDAKCIE CARDS SALON

                    H6(v-if="ADMIN_APP_LANGUAGES.RUSSIAN === language") Нажмите кнопку "Выбрать файл" и укажите путь к новому файлу с изображением карты. После того как путь к файлу будет указан новый прайс будет отправлен и сохранен на сервере автоматически.
                    H6(v-if="ADMIN_APP_LANGUAGES.SLOVAK  === language") Kliknite na tlačidlo "Vybrať súbor" tlačidlo a zadajte cestu do nového súboru s obrazovými mapami. Akonáhle sa zobrazí cesta k súboru nová cena bude automaticky odoslaná a uložené na serveri.
            ...
            name            ="address_map",
            ref             ="upload",
            action          = "/api/admin/panel/address_map",
            )
